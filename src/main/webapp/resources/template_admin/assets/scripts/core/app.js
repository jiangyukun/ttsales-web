...
var App = function () {
    ...
    var handleSidebarMenu = function () {
        ...
        /**zhaoxiaobin   **/
     // handle ajax links within hor-menu
   ...
   // handle ajax links within sidebar menu
    ...
    return {
        ...
        blockUI: function (options) {
            ...
            var html = '';
            if (options.iconOnly) {
                html = '<div class="loading-message ' + (options.boxed ? 'loading-message-boxed' : '')+'"><img style="" src="'+App.getRootPath()+'/resources/template_admin/assets/img/loading-spinner-grey.gif" align=""></div>';
                ...
                html = '<div class="loading-message ' + (options.boxed ? 'loading-message-boxed' : '')+'"><img style="" src="'+App.getRootPath()+'/resources/template_admin/assets/img/loading-spinner-grey.gif" align=""><span>&nbsp;&nbsp;' + (options.message ? options.message : 'LOADING...') + '</span></div>';
            }
        ...
        startPageLoading: function(message) {
            $('.page-loading').remove();
            $('body').append('<div class="page-loading"><img src="'+App.getRootPath()+'/resources/template_admin/assets/img/loading-spinner-grey.gif"/>&nbsp;&nbsp;<span>' + (message ? message : '正在加载中...') + '</span></div>');
        },
