!function (a, b) {
    ...
    function f(a, b) {
        return a = a || {}, a.scope = b, a.signType = "sha1", a.timeStamp = a.timestamp + "", a.nonceStr = a.nonceStr, a.addrSign = a.addrSign, a
    }

    function g(a) {
        return a = a || {}, a.timeStamp = a.timestamp + "", a.nonceStr = a.nonceStr, a.package = a.package, a.paySign = a.paySign, a.signType = "SHA1", a
    }
    ...
    if (!a.jWeixin)return p = {
        ...
        config: function (a) {
            ...
            c(p.getLocation, function () {
                return a.type = "wgs84", f(a, "jsapi_location")
            }(), function () {
                return a._complete = function (a) {
                    delete a.type
                }, a
