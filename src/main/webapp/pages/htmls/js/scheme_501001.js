var schemeCommon = function() {
	...
	function showSubDlg(){ 
		if(global.pTransmitId == "0"){
 		...
 		var openId = $.cookie("openId_501001"); 
	...
	function shareBtn(){
		...
		if(global.pTransmitId == "0"){
			location.href = $.sas.common.getRootPath()+'/qy/lottery/outerIn.do?schemeId=501001' ;
			return;
		}  
 		var isShare = $.cookie("is_share_scheme_501001"); 
 		var openId = $.cookie("openId_501001");
  		 if(isShare=='1' && openId == undefined){
 			var bckurl = $.base64Encode('/qy/lottery/outerIn.do?schemeId=501001');
			location.href = $.sas.common.getRootPath()+'/common/authorize.do?backurl='+ bckurl;
 			return;
 		}else if(isShare=='1'){
 			window.location.href = $.sas.common.getRootPath()+'/qy/lottery/outerIn.do?schemeId=501001';
 			return; 
 		}else{
	...
	function shareSchemeSuccess(){
		if(global.pTransmitId == "0"){
			$.sas.util.setCookie("is_share_scheme_501001",'1',365);
			return ;  
		}
 		var isShare = $.cookie("is_share_scheme_501001"); 
