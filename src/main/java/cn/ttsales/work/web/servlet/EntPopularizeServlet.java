 ...
 * 
 */
public class EntPopularizeServlet extends HttpServlet {
	private Logger log = Logger.getLogger(EntPopularizeServlet.class);
	
	private static final long serialVersionUID = -169437779775570485L;
	private String token = BundleUtil.getProperty(SASConstants.RESOURCE_WEIXIN,
			"wx.corp.agentPopularize.token");
	private String encodingAesKey = BundleUtil.getProperty(SASConstants.RESOURCE_WEIXIN,
			"wx.corp.agentPopularize.aesKey");
	...
	protected void doGet(HttpServletRequest request,
		...
		log.info("EntPopularizeServlet doGet");
		// 微信加密签名
