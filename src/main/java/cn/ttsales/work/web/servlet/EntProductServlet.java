...
/**
 * Servlet implementation class EntProductServlet
 */
public class EntProductServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
	private Logger log = Logger.getLogger(EntProductServlet.class);
	private String token = BundleUtil.getProperty(SASConstants.RESOURCE_WEIXIN,
			"wx.corp.agentProduct.token");
	private String encodingAesKey = BundleUtil.getProperty(SASConstants.RESOURCE_WEIXIN,
			"wx.corp.agentProduct.aesKey");
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		log.info("EntProductServlet doGet");
		// 微信加密签名
